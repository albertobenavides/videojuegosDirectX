...
bool CubeClass::InitializeBuffers(ID3D11Device* device){
	...
	vertices[5].texture = D3DXVECTOR2(0, 3);
	vertices[6].texture = D3DXVECTOR2(3, 0);
	vertices[7].texture = D3DXVECTOR2(3, 3);
	// Bottom
	...
	vertices[9].texture = D3DXVECTOR2(0, 3);
	vertices[10].texture = D3DXVECTOR2(3, 0);
	vertices[11].texture = D3DXVECTOR2(3, 3);
	// Rear
	...
	vertices[13].texture = D3DXVECTOR2(0, 3);
	vertices[14].texture = D3DXVECTOR2(3, 0);
	vertices[15].texture = D3DXVECTOR2(3, 3);
	// Left
	...
	vertices[17].texture = D3DXVECTOR2(0, 3);
	vertices[18].texture = D3DXVECTOR2(3, 0);
	vertices[19].texture = D3DXVECTOR2(3, 3);
	//Top
	...
	vertices[21].texture = D3DXVECTOR2(0, 3);
	vertices[22].texture = D3DXVECTOR2(3, 0);
	vertices[23].texture = D3DXVECTOR2(3, 3);
